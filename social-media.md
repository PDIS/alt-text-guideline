...
這份簡短指南說明圖片的「替代文字」應該如何撰寫，**不涉及**如何挑選或製作圖片，也不涉及社群媒體文字內容或影音內容。
...
- [Facebook 圖片替代文字注意事項](facebook.md)
...
這張圖片跟其他發言亮點圖片的不同之處，在於有兩句話以不同底色標示強調，因此替代文字先強調這兩句話，接著才把圖片中的引述全文寫出來。

另外也請注意，圖片中的文字因排版關係，有些字詞以連字號跨行 (lib-erty, de-mocracy)，在替代文字裡組合回來 (liberty, democracy) 較佳。
...
這則推文有三張照片，第一個替代文字挑戰是：第一張照片跟第三張照片的內容很相似。第二個挑戰是第二張照片為多人合照，但無法一一查證確認所有入境者的面孔。

關於第一個挑戰，範例採用的策略是：點出第一張照片是其中一人向另一人「展示照片拼貼」，而第三張照片是「站在兩旁合照」；同時也利用第一張照片的情境，以及其中照片拼貼呈現出較清楚的畫面，描述這個同樣重要的照片拼貼是怎麼樣的東西，包括其長寬尺寸、內容圖樣等細節。

至於第二個挑戰，在這則推文提到世衛行動團成員，也未逐一介紹，因此以同樣方式表彰整團人的身分即可，並且利用「在活動照片拼貼前」的描述，與其他兩張照片建立起空間關聯性。
...
> 飛機座艙裡的一台 MacBook Pro 筆記型電腦執行文字介面 llama.cpp（附帶 ggml_metal 支援）的畫面，底色為黑色，充滿各種色彩的文字：上半部分的文字是白色的，下半部份的文字是亮黃色，最底端那一行文字是亮綠色。
